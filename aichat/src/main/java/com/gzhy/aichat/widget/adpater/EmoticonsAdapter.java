package com.gzhy.aichat.widget.adpater;
...
public class EmoticonsAdapter<T> extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(getResLayoutId("ist_item_emoticon"), null);
            viewHolder.rootView = convertView;
            viewHolder.ly_root = (LinearLayout) convertView.findViewById(getResId("ll_emoticon_root"));
            viewHolder.iv_emoticon = (ImageView) convertView.findViewById(getResId("iv_emoticon"));
