...
public class ChattingPanelUploadView extends BaseChattingPanelView implements View.OnClickListener {
    ...
    public void initData() {
        ...
        int leaveMsg = SharedPreferencesUtil.getIntData(context, HyAiConstant.sobot_msg_flag,HyAiConstant.sobot_msg_flag_open);
        sobot_robot_btn_leavemsg.setVisibility(leaveMsg == HyAiConstant.sobot_msg_flag_close?View.INVISIBLE:View.VISIBLE);
    ...
    public void onViewStart(Bundle bundle){
        if (bundle.getInt("current_client_model") == HyAiConstant.client_model_robot){
